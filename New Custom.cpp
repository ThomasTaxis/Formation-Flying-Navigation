...
Mat processImage(const std::string& imagePath) {
    ...
    imwrite("Canny_corner_240.png", Original_img_canny);
...
int main(int argc, char** argv) {
    string directoryPath = "C:\\Users\\agsi9\\Documents\\DTU courses\\Special course on image analysis\\P3_nonCoop_DynamicTest_png\\";
